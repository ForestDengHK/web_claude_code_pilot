...
## How to publish
1. Write the file into a dated summary directory in the working directory with a timestamped filename (e.g. \`artifacts-summary/YYYY-MM-DD/artifact-digest-YYYY-MM-DD-HHMMSS.html\`).
